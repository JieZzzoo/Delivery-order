	...
	<form id="content" method="post">
	    ...
	    <table cellpadding="5">
	      <tr>
	        ...
	        <tr>
	            <td>商品分类:</td>
	            <td><input class="easyui-textbox" type="text" name="category" data-options="required:true" style="width: 280px;"></input></td>
	        </tr>
	        <tr>
	            <td>商品子分类:</td>
	            <td>
	            
	            <input class="easyui-textbox" type="text" name="branch" data-options="required:true" style="width: 280px;"></input></td>
	        </tr>
	        <tr>
	            <td>商品库存量:</td>
	        ...
	        <tr>
	            <td>商品图片:</td>
	            <td><input class="easyui-textbox" type="text" name="imgurl" data-options="required:true" style="width: 280px;" value="/productImg"></input></td>
	        </tr>
	    </table>
	</form>
...
<script type="text/javascript">
	function submitForm(){
		...
		$.post("/product/edit",$("#content").serialize(), function(data){
			if(data.status == 200){
				$.messager.alert('提示','编辑商品成功!');
				$('#window').window('close');
				$("#productList").datagrid("reload");
				clearForm();
			}else{
				$.messager.alert('提示','编辑商品失败!');
			}
		});
	}
	function clearForm(){
