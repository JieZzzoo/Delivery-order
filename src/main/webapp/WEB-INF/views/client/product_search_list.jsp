									...
									<ul>
										<c:if test="${bean.pageNum!=1}">
											<li class="disablepage_p">
												<a class="disablepage_a" href="/product/showProductByName?page=${bean.pageNum-1}&name=${name}"></a>
											</li>
										</c:if>
										<c:if test="${bean.pageNum==1}">
										...
										<c:forEach begin="1" end="${bean.pages}" var="page">
											...
											<c:if test="${page!=bean.pageNum}">
												<li><a href="/product/showProductByName?page=${page}&category=${category}">${page}</a>
												</li>
											</c:if>
										</c:forEach>
