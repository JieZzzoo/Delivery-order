...
<body>
	<form action="/client/pay" method="post">
	       <img src="/images/logotop.png" width="400" height="90">
	 <!--       <img src="/images/biao.jpg" width="1518" height="60"> --><br><br><br>
		订单号：<input type="text" name="oId" value="${param.oId}">
		...
		<div style="margin: 40px;">
			<a href="myAccount">
				<img src="/images/fangeren.png" height="30px"/ >  
			
				</a>
				<!-- &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp    <input type="submit" value="   确定支付   "> -->
		</div>
		&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp    <input type="submit" value="   确定支付   ">
			<div style="margin: 40px;">
